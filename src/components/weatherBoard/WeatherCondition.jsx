...
const WeatherCondition = () => {
  ...
  const { minTemperature, maxTemperature, humidity, cloudPercentage, wind, climate } = weatherData;

  return (
    <div>
      <p className="text-sm lg:text-lg font-bold uppercase mb-8">The climate is <span className="text-orange-500" >{climate}</span></p>
